    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
          ...
          <div class="fadeIn first">
            ...
            <h5 class="text-white">Admin Register</h5>
          </div>
          @if (Session::has('error'))
                            <p class="text-danger">{{ Session::get('error') }}</p>
                        @endif

          <form  method="post" action="{{URL::to('/Adminregister')}}">
                            @csrf
                           
            <input  type="text" id="" class="fadeIn second" name="name" placeholder="username ">
            @if ($errors->has('name'))
          ...
          <div id="formFooter">
            ...
            <a class="underlineHover" href="Adminlogin">Already have an Account please login</a>
          </div>
