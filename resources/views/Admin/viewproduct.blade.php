...
<div class="container mt-5 ">
  ...
  @if (Session::has('addmsg'))
                            <p class="text-success">{{ Session::get('addmsg') }}</p>
                        @endif           
  <table class="table table-hover table-responsive table-borderless  mt-5" >
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> <button class="btn btn-sm btn-danger"><a href="delete2/{{$pp->id}}">Delete</a></button></td>
        <td> <button class="btn btn-sm btn-info"><a href="edit1/{{$pp->id}}">Edit</a></button></td>
      </tr>
      @endforeach
    </tbody>
  </table>
