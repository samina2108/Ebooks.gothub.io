...
<body id="body-pd">
        ...
        <header class="header" id="header">
            ...
            <div class="header-wrap">
                            ...
                            <form Action="/search"  class="form-header"   >
        @csrf
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown" style="text-decoration: none; font-weight: 700;">
                                            ...
                                            <div class="account-dropdown__body">
                                                ...
                                                <div class="account-dropdown__item">
                                                    <a href="#">
                                                    <i class="fa-sharp fa-solid fa-envelope"></i>{{ Auth::user()->email }}</a>
                                                </div>
                ...
                <div> <a href="#" class="nav_logo"> <img src="/assets/images/logo.png" id="icon" alt="User Icon" style="width:150px"/> </a>
                    <div style="background-color: rgb(95, 5, 76) ; padding-top: 0.25rem; padding-bottom:0.20rem; border-radius: 30px 30px 0px 30px;" class="nav_list"> 
                        <a href="user" class="nav_link active">
                         ...
                         <a href="publishbook" class="nav_link"> <i class='fa-solid fa-book'></i> 
                            <span class="nav_name">Uplaod Book</span> </a> 

                            <a href="/apply" class="nav_link"> <i class="fa-solid fa-person-snowboarding"></i>
                            <span class="nav_name">Story competition</span> </a> 
                            
                            
                                
                                <a href="fetch" class="nav_link"> <i class='fa-solid fa-eye'>

                                </i> <span class="nav_name">view Products</span>
                             </a> 
                             
                                     <a href="index" class="nav_link"> <i class='fa-solid fa-house'>

                                     </i> <span class="nav_name">Go to Home</span> </a> 
                                     <a href="logout" class="nav_link">
                                     <i class='bx bx-folder nav_icon'></i> <span class="nav_name">Signout</span>
                                     </a> </div>
                </div> 
            </nav>
        </div>
...
text-transform: capitalize;">welcome : {{ Auth::user()->name }}</p>
@yield('dash2')
            @yield('main')
            @yield("fetch")
            @yield("apply")
